...
export const signUp=async(req,res)=>{
    ...
    const creteUser=await userModel.create({userName,email,password:hashedPassword,image:{secure_url,public_id}});
    return res.status(201).json({message:"sucess",creteUser})
